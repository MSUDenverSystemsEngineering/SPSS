...
Try {
	...
	[string]$appScriptDate = '03/31/2023'
	...
	If ($deploymentType -ine 'Uninstall' -and $deploymentType -ine 'Repair') {
		...
		$exitCode = Execute-MSI -Action "Install" -Path "IBM SPSS Statistics.msi" -Transform "1033.MST" -Parameters "REBOOT=ReallySupress /QN INSTALLPYTHON=`"1`" COMPANYNAME=`"Metropolitan State University of Denver`" $installParameters" -SecureParameters -PassThru
	...
	ElseIf ($deploymentType -ieq 'Uninstall')
	{
		...
		$exitCode = Execute-MSI -Action "Uninstall" -Path "{09FBF63E-3FDB-48D1-B2BC-B6AC7709ABE0}" -AddParameters "ALLUSERS=1 REMOVE=`"ALL`"" -PassThru
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCDT4R2Kr6lD0z9J
# zPsuHIELjwHgKC+0M4Xen32yu2535KCCH8EwggVvMIIEV6ADAgECAhBI/JO0YFWU
...
# AYI3AgELMQ4wDAYKKwYBBAGCNwIBFTAvBgkqhkiG9w0BCQQxIgQgF0PEj6wq4O6/
# iRf5OSki1OhQkhwbnCdPkF1ecLW6r+IwDQYJKoZIhvcNAQEBBQAEggGAM9kzmsnL
# l8HqSJj1Ro8SCYoo8b3Tmrg2rfl5XvdOdAyaEoHlYKP8h4kclRH42Am2y6YIszBd
# eqdecQkEPDaI1Sw+gSfHJJgKorza6jhjv8jwTDbNawbrHmXYa2I+s6jaIdQ3/Qdi
# wrhILq5VOm3fTU7KTXbjiEcYP7/3fJum4HinZusVGwDVRKw3ysFFI7Th5AkzdgZj
# gUHz5PAaymbbeDPalPE0WOR3OfAcs3dcAGpkmZv6zZhkyBtkuwpWtw9klMw5alPj
# 7roDw6l+YYMO21OggeRKm6YGnPBEwlay+VlE1L8XsO9yyoJK1ARLFc9CGZAuFdzg
# m0D/24QBIDqR5o0w4fMmMeJtYolLUigkr6nE9Ajn9g0uUcO5GrdzBME7lbfxgFnl
# pDPzT3e98rhL8hFgTdH7KPApY/UapqAyV9KdhTLhLS3fuphLAyjjLWN2oMvhpd5v
# 1Uo5V2WbnZoPlno89wLwuoGobGdgwEf+TaywMkzlpIaYuYTugmXHDCoeoYIDTDCC
...
# BgkqhkiG9w0BCQMxCwYJKoZIhvcNAQcBMBwGCSqGSIb3DQEJBTEPFw0yMzAzMzEy
# MDM4NDVaMD8GCSqGSIb3DQEJBDEyBDBx2WoRGHRIP2mxtJS/sCmWTj9dZqsLnn+d
# rtg4EbKOZmUSt54Jzg0+tFcjVTqjwA4wDQYJKoZIhvcNAQEBBQAEggIAc6h7LieQ
# xgmVrNiIOP7kbwRrOdgezvcA9zj/xJmS1K3Ryy8MGyD8N2nBXwO4d2HfSjlrRHtt
# OlFH6iAEPG4dO59gzZm3cKPlhm+3K0UYH3iKNi5v337BTI1bNrL0QPk89Yat850t
# dX+/p0Ni+jlCiK1F1w90s94YbrBKbMFC070aU9NjpS+JYtSX/c2I8E6tBOzxNH/O
# UZIg8mX34buBQNOOw3PV2T8pNNdaCFnAuwBZC2YbNWTjoRqPo2da9EHsBa8CBx6x
# QynGxwjY40M5BKWr23THaDdQrQrURGQF/bWQ7/2Lv1wzLlv65CArxdFvAyRaIHio
# 4iJQUM4JRVgKFaR+jlN33Wk+VZlktDPQVW8IP83tDQV+QUfbRvPecb0ehu2W+2Sd
# 1OgpbnD2+xM4Dq1zZpZPsQt6FCvjlyfqBdSBvmsNZ3/Oja3IWXXWLrsc3lwqnZXx
# mkZgpAN/ABRo5U+4g29cGEVQPtTKCRK7Co6B4N1cBYOTVOUGC5qP62lJgCb/pF4F
# Yd6h3BoeON+bLkP4jKm/wjbDC/rMQX8kz019qRXTxltgeGi2uaRBEcDZN527jMvZ
# cV1yEuZ6C4+PbdjPlA7ExNI3EpjNuJIbgH5HOg9HdqIHINgAr5pq917gjKZ9xTOY
# w4YY9dTTvRYZDmOUyjS98sPmF0iRZrIy1V8=
