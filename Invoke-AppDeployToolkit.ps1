...
function Install-ADTDeployment
{
    ...
    Show-ADTInstallationWelcome -CloseProcesses stats, spss, amos -CheckDiskSpace -PersistPrompt

    ## Show Progress Message (with the default message).
    Show-ADTInstallationProgress

    ## <Perform Pre-Installation tasks here>
    Uninstall-ADTApplication -Name "SPSS Statistics" -ApplicationType 'MSI'
    ...
    $exitCode = Start-ADTMsiProcess -Action 'Install' -FilePath "IBM SPSS Statistics.msi" -Transforms "1033.MST" -ArgumentList "REBOOT=ReallySupress /QN INSTALLPYTHON=`"1`" COMPANYNAME=`"Metropolitan State University of Denver`" $installParameters" -SecureArgumentList -PassThru
...
function Uninstall-ADTDeployment
{
    ...
    Show-ADTInstallationWelcome -CloseProcesses stats, spss, amos -PersistPrompt
    ...
    $exitCode = Start-ADTMsiProcess -Action "Uninstall" -ProductCode "{BCAFD496-0E48-478D-95F5-84926F298FC0}" -ArgumentList "/QN ALLUSERS=1 REMOVE=`"ALL`"" -PassThru
